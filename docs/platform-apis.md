...
This document describes how to authenticate and which API endpoints to use for GitHub, GitLab, and Bitbucket. It is intended for developing the platform adapters (`coddy/observer/adapters/`).
